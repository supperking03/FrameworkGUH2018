...
export default class NewFriendRequestItem extends Component {
                    ...
                    <View
                        ...
                        <View
                            ...
                            <PrimaryButton
                                ...
                                fontSize={SUBTEXT_FONT_SIZE}
                                style={{borderRadius: 260, marginLeft: 6}}
                                onPress={this.onPressHide.bind(this)}/>
                        </View>
                    </View>
                </TouchableOpacity>
            </View>
...
NewFriendRequestItem.propTypes = {
...
NewFriendRequestItem.defaultProps = ({
    marginLeft: 10,
    marginRight: 10,
